...
import { ShopeePayIcon } from '@/components/icons';
import { Card, CardContent } from '@/components/ui/card';

export default function ShopeePayPaymentPage() {
  ...
  return (
    <div 
        ...
        style={{ backgroundImage: "url('/images/logo-sp.jpeg')" }}
    >
      ...
      <Card className="w-full max-w-sm shadow-lg z-10 bg-white">
        <CardContent className="flex flex-col items-center justify-center space-y-6 p-10">
          <div className="mx-auto h-auto w-32">
            <ShopeePayIcon className="h-full w-full object-contain" />
          </div>
          <div className="flex items-center gap-4">
            <Loader2 className="h-10 w-10 animate-spin text-orange-500" />
            <div className="text-center">
                <h2 className="text-2xl font-semibold text-gray-800">
                    Menghubungi ShopeePay...
                </h2>
